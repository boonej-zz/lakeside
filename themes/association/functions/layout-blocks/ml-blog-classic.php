...
class ML_Blog extends ML_Block {
	...
	function form($instance) {
		...
		$defaults = array('title' => 'Recent Posts', 'subtitle' => 'Optional Subtitle','moretitle' => '','urlmore' => '','post_type' => 'all', 'categories' => 'all', 'posts' => 6,'offset_posts' => "", 'columns_sel' => '4 Columns','height' => '60', 'block_bg_color' => '#f9f9f9','block_text_color' => '#222');
    ...
    ?>
        ...
        <p class="description">
			<label for="<?php echo esc_attr($this->get_field_id('moretitle')) ?>">
				<?php esc_html_e('More Posts - Link Label (optional)','association'); ?>
        ...
        <div class="widgetwrap widgetwrap-alt homeblog" style="padding:<?php echo esc_html($height);?>px 0;">
