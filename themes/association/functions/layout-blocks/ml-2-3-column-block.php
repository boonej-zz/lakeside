...
class ML_2_3_Column_Block extends ML_Block {
	...
	function __construct() {
		...
		$block_options = array(
			...
			'name' => esc_html__('Wide Column','association'),
	...
	function form($instance) {
		...
		__('Wide Column - Drag block items into this column box','association'),
			...
			echo '<li id="template-block-'.$number.'" class="block block-container block-ml_column_block '.$size.'">',
					...
					'<div class="block-settings-column cf" id="block-settings-'.$number.'">',
						...
						'<p class="empty-column">',
							...
							__('2/3 Column - Drag block items into this column box','association'),
